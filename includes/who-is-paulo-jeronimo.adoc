...
. Doing *application architecture* and *software development*, with
*[red]#security in mind#*, for some customers.
. Creating labs and tutorials (like this one) using some tools like
{ncat}, {OpenSSL}, {OpenPGP}, {Passbolt}, {Keycloak}, {mitmproxy},
{Termux} and many others.
